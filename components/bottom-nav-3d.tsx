...
export function BottomNav3D() {
  ...
  const navItems: NavItem[] = [
    ...
    { label: 'Dishes', id: 'dishes', href: '/dishes', icon: List },
    { label: 'Profile', id: 'profile', href: '/profile', icon: User },
  ]

  // Determine active section based on pathname
  const getActiveSection = () => {
    if (pathname === '/') return 'home'
    if (pathname.startsWith('/dishes') || pathname.startsWith('/dish/')) return 'dishes'
  ...
  return (
    <div className="fixed bottom-8 left-0 right-0 z-50 flex items-center justify-center pointer-events-none">
      ...
      >
        ...
        >
          {/* Collapsed state - show only active section with icon */}
          {!expanded && (
              ...
              <AnimatePresence mode="wait">
                {activeItem && (
                  <>
                    ...
                    >
                      <activeItem.icon className="h-5 w-5" style={{ color: '#1a1a1a' }} />
                    </motion.div>
                    <motion.span
                      key={activeItem.id}
          ...
          {/* Expanded state - show all sections with icons */}
          {expanded && (
              ...
              {navItems.map((item, index) => {
                ...
                return (
                  <motion.button
                    ...
                    className="relative cursor-pointer transition-all duration-200 flex flex-col items-center gap-1"
                    style={{
